...
public class Broker {
    ...
    public static String  gatherOrderInfo()
    {
        ...
        while (true){
            ...
            if (CheckBuyInput(msg) == true)
            {
                ...
                } else if (array1[0].equals("MARKET2"))
                {
    ...
    public static Boolean CheckBuyInput(String w) {
        ...
        if (UserInput[0].contains("MARKET1") || UserInput[0].contains("MARKET2")) {
        ...
        if (UserInput[1].contains("DIMPHO") || UserInput[1].contains("OREO"))
        {
            ...
            public void run() {
                ...
                while (true) {
                    try {
                        ...
                        else if (msg.contains("availablemarkets") && msg.length() > 16)
                        {
